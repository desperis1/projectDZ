...
import net.projectdz.gui.BackpackguiGui;
...
public class BackpackItem extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:backpack")
	public static final Item block = null;
	public BackpackItem(ProjecdzModElements instance) {
		super(instance, 118);
