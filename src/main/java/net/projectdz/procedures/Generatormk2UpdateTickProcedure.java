...
public class Generatormk2UpdateTickProcedure extends ProjecdzModElements.ModElement {
	public Generatormk2UpdateTickProcedure(ProjecdzModElements instance) {
		super(instance, 99);
	}
