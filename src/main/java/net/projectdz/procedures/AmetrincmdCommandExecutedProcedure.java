...
public class AmetrincmdCommandExecutedProcedure extends ProjecdzModElements.ModElement {
	public AmetrincmdCommandExecutedProcedure(ProjecdzModElements instance) {
		super(instance, 151);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure AmetrincmdCommandExecuted!");
			return;
		}
