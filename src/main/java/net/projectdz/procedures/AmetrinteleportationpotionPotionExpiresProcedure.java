...
public class AmetrinteleportationpotionPotionExpiresProcedure extends ProjecdzModElements.ModElement {
	public AmetrinteleportationpotionPotionExpiresProcedure(ProjecdzModElements instance) {
		super(instance, 204);
	}
