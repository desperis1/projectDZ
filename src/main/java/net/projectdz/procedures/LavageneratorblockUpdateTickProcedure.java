...
public class LavageneratorblockUpdateTickProcedure extends ProjecdzModElements.ModElement {
	public LavageneratorblockUpdateTickProcedure(ProjecdzModElements instance) {
		super(instance, 146);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new ItemStack(Items.LAVA_BUCKET, (int) (1)).getItem() == (new Object() {
		...
		}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (0)))) && (80 >= (new Object() {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "lavageneratorlevel")))))) {
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
				if (_tileEntity != null)
					_tileEntity.getTileData().putDouble("lavageneratorlevel", ((new Object() {
						public double getValue(BlockPos pos, String tag) {
							TileEntity tileEntity = world.getTileEntity(pos);
							if (tileEntity != null)
								return tileEntity.getTileData().getDouble(tag);
					...
					}.getValue(new BlockPos((int) x, (int) y, (int) z), "lavageneratorlevel")) + 20));
			...
			if ((Math.random() < 0.05)) {
				if (!world.getWorld().isRemote) {
					...
					if (_tileEntity != null)
						...
						}.getValue(new BlockPos((int) x, (int) y, (int) z), "lavageneratorlevel")) - 1));
					world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
				}
			}
		}
