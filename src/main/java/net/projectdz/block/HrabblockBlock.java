...
public class HrabblockBlock extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:hrabblock")
	public static final Block block = null;
	public HrabblockBlock(ProjecdzModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HrabplanksBlock.block, (int) (1)));
		}
	}
}
