...
public class NakedplantBlock extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:nakedplant")
	public static final Block block = null;
	public NakedplantBlock(ProjecdzModElements instance) {
		super(instance, 166);
	}
