...
import net.projectdz.procedures.GoldlogBlockDestroyedByPlayerProcedure;
...
public class GoldlogBlock extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:goldlog")
	public static final Block block = null;
	public GoldlogBlock(ProjecdzModElements instance) {
		super(instance, 153);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				GoldlogBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
