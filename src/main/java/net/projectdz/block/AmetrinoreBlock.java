...
public class AmetrinoreBlock extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:ametrinore")
	public static final Block block = null;
	public AmetrinoreBlock(ProjecdzModElements instance) {
		super(instance, 102);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("ametrinore", "ametrinore", blockAt -> {
