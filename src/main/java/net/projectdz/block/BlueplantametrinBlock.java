...
public class BlueplantametrinBlock extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:blueplantametrin")
	public static final Block block = null;
	public BlueplantametrinBlock(ProjecdzModElements instance) {
		super(instance, 165);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blueplantametrin");
		}
