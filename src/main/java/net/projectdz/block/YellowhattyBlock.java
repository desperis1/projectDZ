...
public class YellowhattyBlock extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:yellowhatty")
	public static final Block block = null;
	public YellowhattyBlock(ProjecdzModElements instance) {
		super(instance, 168);
	}
