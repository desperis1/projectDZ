...
public class PurplearrowBlock extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:purplearrow")
	public static final Block block = null;
	public PurplearrowBlock(ProjecdzModElements instance) {
		super(instance, 167);
	}
