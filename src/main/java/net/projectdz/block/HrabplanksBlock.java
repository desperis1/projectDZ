...
public class HrabplanksBlock extends ProjecdzModElements.ModElement {
	@ObjectHolder("projecdz:hrabplanks")
	public static final Block block = null;
	public HrabplanksBlock(ProjecdzModElements instance) {
		super(instance, 2);
	}
