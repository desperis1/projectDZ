...
public class AdminMENUGui extends ProjecdzModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public AdminMENUGui(ProjecdzModElements instance) {
		super(instance, 218);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			}
			{
				...
				AdminMENUThisGUIIsOpenedProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("projecdz:textures/admin_menu.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Admin Menu", 157, 6, -16751104);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 280, this.guiTop + 23, 70, 20, "Clear Lag", e -> {
				ProjecdzMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 13, this.guiTop + 22, 120, 20, "Creative / Survival", e -> {
				ProjecdzMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(1, x, y, z));
				handleButtonAction(entity, 1, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 29, this.guiTop + 47, 80, 20, "Day / Night", e -> {
		...
		if (buttonID == 0) {
			{
				...
				ClearlagCommandExecutedProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				AdminMenuCreativeButtonpressedProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
