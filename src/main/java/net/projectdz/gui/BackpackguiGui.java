...
public class BackpackguiGui extends ProjecdzModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BackpackguiGui(ProjecdzModElements instance) {
		super(instance, 119);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 63, 45) {
			}));
			...
			this.customSlots.put(31, this.addSlot(new SlotItemHandler(internal, 31, 79, 4) {
			}));
			this.customSlots.put(32, this.addSlot(new SlotItemHandler(internal, 32, 99, 4) {
			}));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("projecdz:textures/backpackgui.png");
		@Override
