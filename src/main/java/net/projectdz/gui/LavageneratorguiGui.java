...
public class LavageneratorguiGui extends ProjecdzModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public LavageneratorguiGui(ProjecdzModElements instance) {
		super(instance, 145);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("lavageneratorgui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("projecdz:textures/lavageneratorgui.png");
		@Override
