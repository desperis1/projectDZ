...
public class AmetrincowEntity extends ProjecdzModElements.ModElement {
	public static EntityType entity = null;
	public AmetrincowEntity(ProjecdzModElements instance) {
		super(instance, 169);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 1.4f)).build("ametrincow")
						.setRegistryName("ametrincow");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13382656, -6750106, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("ametrincow_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 8, 1, 4));
		}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new CowModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("projecdz:textures/ametrin_cow.png");
			}
		});
	}
