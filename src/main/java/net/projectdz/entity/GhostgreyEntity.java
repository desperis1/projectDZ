...
public class GhostgreyEntity extends ProjecdzModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("projecdz:entitybulletghostgrey")
	public static final EntityType arrow = null;
	public GhostgreyEntity(ProjecdzModElements instance) {
		super(instance, 157);
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("projecdz:textures/ghost.png");
				}
			};
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1, new Goal() {
				...
				public void startExecuting() {
					...
					CustomEntity.this.moveController.setMoveTo(vec3d.x, vec3d.y, vec3d.z, 6);
				}
