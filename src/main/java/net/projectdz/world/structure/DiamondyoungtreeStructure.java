...
public class DiamondyoungtreeStructure extends ProjecdzModElements.ModElement {
	public DiamondyoungtreeStructure(ProjecdzModElements instance) {
		super(instance, 176);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 400000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("projecdz", "diamond_youngtree"));
						if (template == null)
							return false;
