...
public class Ametrinemeraldzrucanina1Structure extends ProjecdzModElements.ModElement {
	public Ametrinemeraldzrucanina1Structure(ProjecdzModElements instance) {
		super(instance, 161);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("projecdz", "ametrin_emerald_zrucanina1"));
						if (template == null)
							return false;
