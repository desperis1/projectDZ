...
public class DiamondminitreeStructure extends ProjecdzModElements.ModElement {
	public DiamondminitreeStructure(ProjecdzModElements instance) {
		super(instance, 175);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 400000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("projecdz", "diamond_minitree"));
						if (template == null)
							return false;
