...
public class SpadnutyoakStructure extends ProjecdzModElements.ModElement {
	public SpadnutyoakStructure(ProjecdzModElements instance) {
		super(instance, 164);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("projecdz", "spadnuty_oak"));
						if (template == null)
							return false;
