...
public class GoldminitreeStructure extends ProjecdzModElements.ModElement {
	public GoldminitreeStructure(ProjecdzModElements instance) {
		super(instance, 177);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 400000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("projecdz", "gold_minitree"));
						if (template == null)
							return false;
