...
public class EmeraldminitreeStructure extends ProjecdzModElements.ModElement {
	public EmeraldminitreeStructure(ProjecdzModElements instance) {
		super(instance, 179);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 400000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("projecdz", "emerald_minitree"));
						if (template == null)
							return false;
