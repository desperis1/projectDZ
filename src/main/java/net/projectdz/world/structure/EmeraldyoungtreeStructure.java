...
public class EmeraldyoungtreeStructure extends ProjecdzModElements.ModElement {
	public EmeraldyoungtreeStructure(ProjecdzModElements instance) {
		super(instance, 180);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 400000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("projecdz", "emerald_youngtree"));
						if (template == null)
							return false;
