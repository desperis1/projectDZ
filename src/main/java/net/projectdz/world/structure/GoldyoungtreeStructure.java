...
public class GoldyoungtreeStructure extends ProjecdzModElements.ModElement {
	public GoldyoungtreeStructure(ProjecdzModElements instance) {
		super(instance, 178);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 400000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("projecdz", "gold_youngtree"));
						if (template == null)
							return false;
